...
const manufacturerCode = 0x4703;
 export default {
        ...
        vendor: "ONOKOM",
        description: "AIR OK-AC-H-HR-1-ZB-S-A (Адаптер для бытовых и полупромышленных систем Haier)",
        ota: true,
        extend: [
            m.enumLookup({
                name: "ac_connected",
            ...
            m.numeric({
                ...
                valueMax: 8,
                valueStep: 1,
                description: "Положение горизонтальных шторок: Остановлены(0), Качание(1), Самый низ(2), Самый верх(8)",
                zigbeeCommandOptions: {manufacturerCode},
            }),
            m.numeric({
                name: "fan_speed",
