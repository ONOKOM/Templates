...
const manufacturerCode = 0x4703;
 export default {
        ...
        vendor: "ONOKOM",
        description: "AIR OK-AC-H-ONOKOM-AIR-ME-1-ZB-S-A (Адаптер для бытовых и полупромышленных систем Mitsubishi Electric)",
        ota: true,
        extend: [
            m.enumLookup({
                name: "ac_connected",
            ...
            m.numeric({
                ...
                valueMax: 4,
                valueStep: 1,
                description: "Скорость вентилятора: Авто(0), Первая(1) - Максимальная(4)",
                zigbeeCommandOptions: {manufacturerCode},
            }),
            m.numeric({
                ...
                valueMax: 5,
                valueStep: 1,
                description: "Расширенная скорость вентилятора: Авто (0), Тихий (1), Первая (2) ... Максимальная (4)",
                zigbeeCommandOptions: {manufacturerCode},
            }),
            m.numeric({
                name: "vanes_swing",
