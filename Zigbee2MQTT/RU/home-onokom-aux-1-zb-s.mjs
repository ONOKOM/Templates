...
const manufacturerCode = 0x4703;
 export default {
        ...
        vendor: "ONOKOM",
        description: "AIR OK-AC-H-AUX-1-ZB-S-A (Адаптер для бытовых и полупромышленных систем AUX)",
        ota: true,
        extend: [
            m.enumLookup({
                name: "ac_connected",
            ...
            m.numeric({
                ...
                valueMax: 5,
                valueStep: 1,
                description: "Расширенная скорость вентилятора: Авто (0), Тихий (1), Первая (2) ... Максимальная (4), Турбо(5)",
                zigbeeCommandOptions: {manufacturerCode},
            }),
            m.numeric({
                name: "vanes_swing",
            ...
            m.numeric({
                ...
                valueMax: 100,
                valueStep: 1,
                description: "Текущая мощность компрессора",
                zigbeeCommandOptions: {manufacturerCode},
            }),
            m.numeric({
                ...
                valueMax: 100,
                valueStep: 1,
                description: "Ограничение мощности компрессора",
                zigbeeCommandOptions: {manufacturerCode},
            }),
        ],
        fromZigbee: [
